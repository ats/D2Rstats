...
## row {height: 25%}
Per [activity definition](https://bungie-net.github.io/multi/schema_Destiny-Definitions-DestinyActivityDefinition.html#schema_Destiny-Definitions-DestinyActivityDefinition), `69` corresponds to all competetive PVP modes:
```{r}
#| echo: true
pvp_games |> filter_mode(69) |> 
...
#| eval: false
#| show: false
a <- head(pvp_games, n=100) |> select(instanceId) |> group_by(instanceId) |> 
